...
export const CtaSection = () => (
    <section id="cta" className="container" style={{ textAlign: 'center' }}>
        ...
        <a href="https://github.com/VictorHungria/ConnectJus/releases/download/v0.0.2-alpha/ConnectJusDocs-Setup-0.0.2-alpha.exe" className="button-primary" style={{ padding: '16px 32px', fontSize: '1.125rem' }}>
          Download Gratuito
        </a>
    </section>
);
