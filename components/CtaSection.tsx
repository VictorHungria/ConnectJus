...
export const CtaSection = () => (
    <section id="cta" className="container" style={{ textAlign: 'center' }}>
        ...
        <a href="https://github.com/VictorHungria/ConnectJus/releases/download/v0.0.3-alpha/ConnectJusDocs-Setup-0.0.3-alpha.exe" target="_blank" rel="noopener noreferrer" className="button-primary" style={{ padding: '16px 32px', fontSize: '1.125rem' }}>
          Download Gratuito
        </a>
    </section>
);